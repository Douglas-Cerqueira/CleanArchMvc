...
{
    //Sealed faz com que as classes nao possam ser herdadas
    public sealed class Product : Entity
    {
        ...
        public void ValidateDomain(string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExceptionValidation.When(image.Length > 250, "Invalid Image Name. Too short, maximum 250 characters");
            Name = name;
